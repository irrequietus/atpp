...
{\color{tone1}revision} & \texttt{\GitShortRev{}} - \href{http://atpp.irrequietus.eu}{http://atpp.irrequietus.eu}\\
\end{tabular}}}{\slshape Annotated C++ template parameter packs\\
\bf{\color{tone1}{uncorrected draft revision:} {\color{magenta} \GitShortRev{} - \GitCommitDate{}}}}}
