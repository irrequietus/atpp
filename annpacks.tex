...
{\color{red}\textbf{DISCLAIMER: }}\textit{{\color{tone1} The current document is a publically disclosed but uncorrected and incomplete draft for a developing C++ proposal.
{\textbf{\color{red}{It is not a complete work yet.}}}
As a consequence, several omissions, repetitions or inadequate development of the notions involved are to be taken care of in future releases of this document.
...
\end{minted}
\p While the same effect could be achieved through extensive use of SFINAE and/or tag dispatching, it would require a lot more boilerplate.
